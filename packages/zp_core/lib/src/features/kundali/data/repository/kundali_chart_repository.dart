...
class StubKundaliChartRepository implements KundaliChartRepository {
  ...
  static const _planetShortForms = [
    KundaliShortForm(shortForm: 'Su', label: 'Sun', asset: KundaliAssets.sun),
    KundaliShortForm(shortForm: 'Mo', label: 'Moon', asset: KundaliAssets.moon),
    KundaliShortForm(shortForm: 'Ma', label: 'Mars', asset: KundaliAssets.mars),
    KundaliShortForm(
      shortForm: 'Me',
      label: 'Mercury',
    ...
    KundaliShortForm(
        shortForm: 'Ve', label: 'Venus', asset: KundaliAssets.venus),
    KundaliShortForm(
      shortForm: 'Sa',
      label: 'Saturn',
      asset: KundaliAssets.saturn,
    ),
    KundaliShortForm(shortForm: 'Ra', label: 'Rahu', asset: KundaliAssets.rahu),
    KundaliShortForm(shortForm: 'Ke', label: 'Ketu', asset: KundaliAssets.ketu),
    KundaliShortForm(
      shortForm: 'Ur',
      label: 'Uranus',
    ...
    KundaliShortForm(
        shortForm: 'Pu', label: 'Pluto', asset: KundaliAssets.pluto),
  ];
