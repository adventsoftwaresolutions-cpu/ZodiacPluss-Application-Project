...
class TicketAttachmentArea extends StatelessWidget {
  ...
  Widget build(BuildContext context) => InkWell(
        ...
        onTap: () async {
          const List<String> mockFiles = <String>[
            'screenshot.png',
            'session-details.pdf',
            'support-document.docx',
          ];
          final String? file = await showModalBottomSheet<String>(
            context: context,
            showDragHandle: true,
          ...
          if (file != null) onAddAttachment(file);
        },
        child: CustomPaint(
            ...
            child: attachments.isEmpty
                ? const Column(
                    ...
                    children: <Widget>[
                      ...
                      SizedBox(height: 3),
                      Text('Images, PDF, or documents (Max 10MB)',
