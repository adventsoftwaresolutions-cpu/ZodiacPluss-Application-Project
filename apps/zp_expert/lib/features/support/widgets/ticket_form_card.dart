        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            DropdownButtonFormField<String>(
              ...
              style: const TextStyle(color: AppColors.ticketText, fontSize: 13),
              decoration: _fieldDecoration(
                hint: 'Select a Category',
                prefix: SvgPicture.asset(AppAssets.categoryIcon, width: 21),
              ),
            ...
            TextFormField(
              ...
              decoration: _fieldDecoration(
                ...
                prefix: SvgPicture.asset(AppAssets.pencilIcon, width: 21),
              ),
            ...
            TextFormField(
              ...
              decoration: _fieldDecoration(
                ...
                prefix: SvgPicture.asset(AppAssets.notesIcon, width: 21),
