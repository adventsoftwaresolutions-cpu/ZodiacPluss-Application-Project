enum KundaliChartSection {
  ...
  const KundaliChartSection(this.label, this.apiValue);
...
enum KundaliChartStyle {
  ...
  const KundaliChartStyle(this.label, this.apiValue);
...
enum KundaliDivision {
  ...
  const KundaliDivision(this.shortLabel, this.label, this.apiValue);
