...
String _assetFor(KundaliPlanetId planet) => switch (planet) {
      KundaliPlanetId.sun => AppAssets.kundaliSun,
      KundaliPlanetId.moon => AppAssets.kundaliMoon,
      KundaliPlanetId.mercury => AppAssets.kundaliMercury,
      KundaliPlanetId.venus => AppAssets.kundaliVenus,
      KundaliPlanetId.mars => AppAssets.kundaliMars,
      KundaliPlanetId.jupiter => AppAssets.kundaliJupiter,
      KundaliPlanetId.saturn => AppAssets.kundaliSaturn,
      KundaliPlanetId.rahu => AppAssets.kundaliRahu,
      KundaliPlanetId.ketu => AppAssets.kundaliKetu,
      KundaliPlanetId.uranus => AppAssets.kundaliUranus,
      KundaliPlanetId.neptune => AppAssets.kundaliNeptune,
      KundaliPlanetId.pluto => AppAssets.kundaliPluto,
      KundaliPlanetId.ascendant => AppAssets.logo,
    };
